...
public class HorizonCellSceneView : MonoBehaviour 
{
	...
	[SerializeField]
	private HorizonCellView view = null;

	[SerializeField]
	private Color sceneViewHighlight;

	void DrawSolidRectangleGizmo(Vector3[] points, Color color)
	{
		Mesh RectangleMesh = new Mesh();
		RectangleMesh.vertices = points;
	...
	public void OnDrawGizmos()
	{
		...
		if(view == null) view  = gameObject.GetComponent<HorizonCellView>();

		UpdateSceneViewHighlight();

		DrawSolidRectangleGizmo(
			new Vector3[]{ 
